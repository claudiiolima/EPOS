...
public:
    ...
    static void sleep(Queue &_waiting);
    static void wakeup(Queue &_waiting);
    static void wakeup_all(Queue &_waiting);
...
protected:
    ...
    Thread * volatile _joined; // ADICIONADO
...
private:
    ...
    static volatile unsigned int _count;
};
